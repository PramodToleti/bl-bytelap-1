...
function CompanySetting() {
  return (
    <>
      <EmployeeHome />
      <div className="col-lg-6 col-md-6 search-course-right   mb-0 mt-4 p-2   bg-light    border-secondary rounded container reveal  p-3 mb-5   rounded border border-secondary">
