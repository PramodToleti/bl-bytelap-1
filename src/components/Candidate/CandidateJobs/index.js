...
const CandidateJobs = (props) => {
  ...
  return internJobs.map((data, index) => (
    <div
      className="col-lg-6 col-md-4 search-course-right text-dark mb-4   div-card rounded container reveal p-2 rounded "
      style={{
        width: "100%",
        ...
        >
          ...
          >
            {data.jobType === "Work from Home" ? (
              <>
                <FaHome className="icon-styles" style={{ marginTop: "4px" }} />
                <p
                  style={{
                    color: "grey",
                  }}
