                ...
                <div>
                  <div className="recommendation-card">
                    ...
                    <p style={{ textAlign: "start" }}>
                      They are logical and simple to work with, quietly listen
                      to your requirement, and provide you with excellent
                      counsel from a distance. At the core of their
                      customer-centricity is the automation technology they use,
                      which entails bringing the Talent closer to each stage of
                      the process.
                    </p>
                  </div>
